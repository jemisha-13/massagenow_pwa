...
export class ShopDetailComponent implements OnInit {
  ...
  // routing
  goToService(){
    this.router.navigate(['main/home/select-service'],{queryParams: {
  ...
  goTOReview(){
    this.router.navigate(['main/all-reviews'],{queryParams: {
      locationId: this.locationId
    }});
  }
  ...
  selectedService(item: any){
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        document.querySelector('.therapist-block .btn-dark')!.scrollIntoView({
          behavior: 'smooth'
        });
      }, 500);
    }, time);
